        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul id="groupList" class="nav navbar-nav">
                    ...
                    <li><button type="button" id="clear_group" class="btn btn-default navbar-btn">Clear Group</button></li>
    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${groups}" var="group">
            <tr>
                ...
                <td>${group.name}</td>
                <td><a href="/group/${group.id}">${group.count}</a></td>
            </tr>
        </c:forEach>
    </table>
...
<script>
    ...
    $('#delete_group').click(function(){
        ...
        $.post("/groups/delete", data, function(data, status) {
    ...
    $('#clear_group').click(function(){
        ...
        $.post("/groups/clear", data, function(data, status) {
            window.location.reload();
        });
    });
